...
function TierCard({ tier, index }: any) {
    ...
    return (
        <motion.div
            ...
            className="dotted-grid bg-white rounded-3xl p-16 border border-gray-200"
        >
            <h3 className="text-4xl font-semibold mb-6 text-[#121317]">{tier.title}</h3>
...
export default function TierCards() {
    return (
        <section className="py-40 px-[72px] bg-gray-50">
